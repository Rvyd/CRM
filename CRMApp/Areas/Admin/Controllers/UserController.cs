...
namespace CRMApp.Areas.Admin.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        public async Task<IActionResult> ResetPassword([FromForm] ResetDto resetDto)
        {
            if (ModelState.IsValid)
            {
                var result = await _manager.AuthService.ResetPassword(resetDto);
            ...
            return View(resetDto); // View'a ResetDto nesnesini geri döndürür, böylece kullanıcı tekrar doldurabilir
        }
